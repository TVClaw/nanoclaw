...
// Non-secret keys from project .env take precedence over inherited
// process.env so ASSISTANT_NAME in .env is not overridden by a stale
// shell profile or launchd plist. Secrets stay in credential proxy only.
...
// Auto-reset Claude session after this many minutes of idle (clears context history).
